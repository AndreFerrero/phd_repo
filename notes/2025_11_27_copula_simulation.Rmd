---
title: "Copula Simulation - Univariate Case"
date: "2025-11-27"
output: pdf_document
---
...
Below we can see different realisations from a Gumbel-Frechet model and different theta parameters. It seems that the same theta parameter can produce very different samples. When we perform estimation of the parameter, could this create non identifiability?
